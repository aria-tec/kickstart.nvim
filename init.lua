...
do
  ...
  -- [[ Navigasi Jendela Split ]]
  -- NOTIF: Baris bawaan di bawah ini dinonaktifkan (dikomentari) karena kita
  -- menggunakan plugin `vim-tmux-navigator` (yang dikonfigurasi secara modular
  -- di `lua/custom/plugins/tmux.lua`) agar navigasi split tersambung mulus
  -- antara Neovim dan panel Tmux.
  --
...
do
  ...
  -- [[ Colorscheme ]]
  -- NOTIF: Tema warna bawaan Kanagawa di bawah ini dinonaktifkan (dikomentari)
  -- karena kita menggunakan tema kustom `mini.base16` yang dikonfigurasi secara modular
  -- di dalam berkas `lua/custom/plugins/colorscheme.lua`.
  --
...
do
  ...
  vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
      ...
      -- NOTIF: Baris bawaan di bawah ini dinonaktifkan (dikomentari) karena kita
      -- menggunakan plugin `inc-rename.nvim` (yang dikonfigurasi secara modular
      -- di `lua/custom/plugins/extra.lua`) untuk rename interaktif real-time.
      --
